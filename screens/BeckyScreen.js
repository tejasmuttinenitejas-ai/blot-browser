...
export default function BeckyScreen({ navigation }) {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: "Hi, I'm Becky. Ask me anything." },
  ]);
  ...
  const handleSend = async () => {
    ...
    const result = await askBecky(apiMessages);
    setLoading(false);
      ...
      >
        ...
        {loading && (
          <View style={styles.typingRow}>
            ...
            <Text style={styles.typingText}>Becky is thinking…</Text>
          </View>
        )}
